...
sed -i -e'/main_db:/!b' -e ':a' -e "s/username.*/username: $MYSQL_USER/;t trail" -e 'n;ba' -e ':trail' -e 'n;btrail' /opt/postal/config/postal.yml
...
sed -i -e'/message_db:/!b' -e ':a' -e "s/username.*/username: $MYSQL_USER/;t trail" -e 'n;ba' -e ':trail' -e 'n;btrail' /opt/postal/config/postal.yml
